...
const CTABanner = () => {
  return (
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto glass-card p-12 text-center relative overflow-hidden">
        <div
        ...
        <Link
          to={"/analyse"}
          className="btn-primary inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-sm font-semibold relative z-10"
        >
          Analyse Resume For Free <ArrowRight size={16} />
        </Link>
      </div>
    </section>
  );
