  ...
  return (
    ...
    >
      ...
      {isPro
        ...
        : "You're on the Free Plan • 5 requests included"}
    </div>
  );
}
...
function PlanCTA({
  ...
  const handleSubscribe = async (price: any) => {
    ...
    const options = {
      key: "rzp_test_SufNC4TdovvlRC", // Enter the Key ID generated from the Dashboard
  ...
  return (
    <section id="pricing" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-white/40 mt-4 max-w-md mx-auto text-sm lg:text-base">
          Your first 5 requests are completely free - no card needed.
        </p>
